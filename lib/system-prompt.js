...
- Per qualsiasi domanda aziendale (clienti, viaggi, strutture): cerca PRIMA in wiki/Airtable
- Se la wiki non trova nulla di rilevante: restituisce l'indice completo — usalo per navigare e proporre query alternative
`,
  ].join('');
}
